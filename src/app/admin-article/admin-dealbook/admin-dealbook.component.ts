...
@Component({
  selector: 'app-admin-dealbook',
  templateUrl: './admin-dealbook.component.html',
  styleUrls: ['./admin-dealbook.component.css']
})
export class AdminDealbookComponent implements OnInit {
